...
#ifndef TFCOMPILE_GENERATED___xla___graph_H_  // NOLINT(build/header_guard)
#define TFCOMPILE_GENERATED___xla___graph_H_  // NOLINT(build/header_guard)
...
//   (arg0: f32[1,1,9], arg1: f32[1,64]) -> (f32[1,1,5], f32[1,64])
//
// Memory stats:
//   arg bytes total:    292
 ...
 public:
  ...
  static const tensorflow::XlaCompiledCpuFunction::StaticData& StaticData() {
    static XlaCompiledCpuFunction::StaticData* kStaticData = [](){
      ...
      set_static_data_raw_function(data, __xla___graph);
  ...
  float& arg0(size_t dim0, size_t dim1, size_t dim2) {
    return (*static_cast<float(*)[1][1][9]>(
        arg_data(0)))[dim0][dim1][dim2];
  }
  const float* arg0_data() const {
    return static_cast<const float*>(arg_data(0));
  }
  const float& arg0(size_t dim0, size_t dim1, size_t dim2) const {
    return (*static_cast<const float(*)[1][1][9]>(
        arg_data(0)))[dim0][dim1][dim2];
  }
  ...
  const float& arg1(size_t dim0, size_t dim1) const {
    return (*static_cast<const float(*)[1][64]>(
        arg_data(1)))[dim0][dim1];
  }
  ...
  float& result0(size_t dim0, size_t dim1, size_t dim2) {
    return (*static_cast<float(*)[1][1][5]>(
        result_data(0)))[dim0][dim1][dim2];
  }
  const float* result0_data() const {
    return static_cast<const float*>(result_data(0));
  }
  const float& result0(size_t dim0, size_t dim1, size_t dim2) const {
    return (*static_cast<const float(*)[1][1][5]>(
        result_data(0)))[dim0][dim1][dim2];
  }
...
::xla::cpu_function_runtime::BufferInfo({2560ULL, ~0ULL}),
...
10, 9
  ...
  static constexpr size_t kResultIndex = 13;
...
#endif  // TFCOMPILE_GENERATED___xla___graph_H_
