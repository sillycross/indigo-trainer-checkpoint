...
//   (arg0: f32[1,9], arg1: f32[1,64]) -> (f32[1,5], f32[1,64])
//
// Memory stats:
//   arg bytes total:    292
//   arg bytes aligned:  320
//   temp bytes total:   324
...
class Graph final : public tensorflow::XlaCompiledCpuFunction {
 public:
  ...
  const float& result0(size_t dim0, size_t dim1) const {
    return (*static_cast<const float(*)[1][5]>(
        result_data(0)))[dim0][dim1];
  }
...
::xla::cpu_function_runtime::BufferInfo({1152ULL, ~0ULL}),
::xla::cpu_function_runtime::BufferInfo({1025ULL, ~0ULL}),
::xla::cpu_function_runtime::BufferInfo({1024ULL, ~0ULL}),
...
::xla::cpu_function_runtime::BufferInfo({19ULL, ~0ULL}),
::xla::cpu_function_runtime::BufferInfo({19ULL, ~0ULL}),
::xla::cpu_function_runtime::BufferInfo({129ULL, ~0ULL})
      };
    return kBufferInfos;
  }
